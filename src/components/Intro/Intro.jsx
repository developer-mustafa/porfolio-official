    ...
    <section className="i">
      ...
      <div className="i-left">
        <div className="i-left-wrapper">
          <h2 data-aos="fade-up" className="i-intro">Hello,I'm</h2>
          ...
          <p className="i-desc">
            ...
            specializing in creating stylish, modern websites ,web Application, web services and
            online stores.
          </p>
          <div className="i-Btn">
            <Link to="/contactme">
            ...
            <a href="https://drive.google.com/file/d/1mz5hvT0CvnWK1dapjxhruvdjIKDOHPnq/view?usp=sharing" download>
